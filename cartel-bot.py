...
# Dictionary with files for different languages
language_files = {
    "ru": 'bot.db',
    "en": 'bot_eng.db',
}
...
async def echo(message: types.Message):
    ...
    user_id = message.from_user.id
    user_language_code = user_language.get(user_id, "ru")
    filename = language_files.get(user_language_code, "ru")
...
if __name__ == "__main__":
    create_table()  # Создать таблицу, если она не существует
    insert_data_to_db()  # Заполнить таблицу данными
